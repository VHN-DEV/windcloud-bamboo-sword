...
const ENEMY_MATERIAL_DROPS = Object.freeze({
    ...
    "agave": { LINH_LAN: 4.6, DOC_NANG: 1.8, NGAN_NAM_HOANG_TINH: 0.6 },
    "algae": { LINH_LAN: 4.5, TINH_THIT: 1.4, TUYET_NGOC_THAO: 0.45 },
    "alien-bug": { PHONG_CHAM: 4.8, DOC_NANG: 2.7, YEU_HUYET: 1.1 },
    "alien-egg": { YEU_DAN: 4.3, YEU_HUYET: 2.1, THIEN_LINH_QUA: 0.32 },
    "alien-stare": { YEU_HUYET: 4.0, DOC_NANG: 2.2, HUYEN_HOA_LIEN: 0.4 },
    "animal-spider": { LINH_TY: 5.0, PHONG_CHAM: 2.6, DOC_NANG: 1.9 },
    "animal-tasmanian-devil": { YEU_NANH: 5.2, TINH_THIT: 1.9, YEU_HUYET: 1.4 },
    "bamboo": { LINH_TY: 3.8, LINH_LAN: 2.4, NGAN_NAM_HOANG_TINH: 0.9 },
    "bastet": { LINH_MAO: 5.1, YEU_HUYET: 1.8, THIEN_LINH_QUA: 0.4 },
    "bat": { LINH_VU: 4.9, YEU_HUYET: 2.0, DOC_NANG: 1.2 },
    "battle-mech": { GIAP_XAC: 5.4, YEU_COT: 2.0, LINH_LAN: 1.3 },
    "beanstalk": { LINH_TY: 4.1, TINH_THIT: 1.1, HUYEN_HOA_LIEN: 0.45 },
    "beast-eye": { YEU_HUYET: 4.8, YEU_DAN: 1.8, THIEN_LINH_QUA: 0.36 },
    "bestial-fangs": { YEU_NANH: 5.7, YEU_HUYET: 1.6, TINH_THIT: 1.2 },
    "big-elephant": { TU_NGA: 5.6, YEU_BI: 2.5, YEU_COT: 1.6 },
    "broken-skull": { YEU_COT: 5.6, YEU_HUYET: 1.3, GIAP_XAC: 1.0 },
    "brute": { YEU_BI: 4.9, TINH_THIT: 2.1, YEU_COT: 1.5 },
    "buffalo-head": { YEU_GIAC: 5.5, YEU_BI: 1.9, TINH_THIT: 1.5 },
    "carnivore-mouth": { YEU_NANH: 5.9, YEU_HUYET: 1.7, TINH_THIT: 1.4 },
    "cobra": { DOC_NANG: 5.3, YEU_NANH: 1.7, LINH_TY: 1.2 },
    "cthulhu": { XUC_TU: 5.6, YEU_DAN: 2.2, HUYEN_HOA_LIEN: 0.5 },
    "dawn": { LINH_VU: 4.0, LINH_LAN: 2.1, THIEN_LINH_QUA: 0.34 },
    "dragon2": { LONG_LAN: 5.7, YEU_DAN: 2.0, YEU_HUYET: 1.4 },
    "dragon3": { LONG_LAN: 5.9, YEU_DAN: 2.3, THIEN_LINH_QUA: 0.45 },
    "drakkar-dragon": { LONG_LAN: 5.5, GIAP_XAC: 1.6, YEU_DAN: 1.9 },
    "faction-ironbanner": { GIAP_XAC: 5.1, YEU_COT: 1.8, LINH_VU: 1.0 },
    "fajrfilmfestival": { LINH_VU: 3.7, YEU_HUYET: 1.3, TUYET_NGOC_THAO: 0.4 },
    "food-chain": { TINH_THIT: 4.8, YEU_NANH: 1.8, YEU_HUYET: 1.2 },
    "gambit": { LINH_LAN: 3.9, YEU_DAN: 1.6, HUYEN_HOA_LIEN: 0.35 },
    "gryphon": { LINH_VU: 5.2, YEU_NANH: 2.0, YEU_HUYET: 1.4 },
    "helicoprion": { YEU_NANH: 5.4, LINH_LAN: 2.3, TINH_THIT: 1.5 },
    "hunter-smoke": { LINH_MAO: 4.4, YEU_HUYET: 1.5, DOC_NANG: 1.0 },
    "ice-golem": { GIAP_XAC: 5.3, YEU_COT: 2.1, TUYET_NGOC_THAO: 0.7 },
    "kraken": { XUC_TU: 5.8, LINH_LAN: 2.1, YEU_HUYET: 1.6 },
    "krakenjs": { XUC_TU: 5.1, LINH_TY: 1.8, YEU_DAN: 1.5 },
    "leviathan-dogs": { YEU_NANH: 5.5, LONG_LAN: 1.7, TINH_THIT: 1.6 },
    "mammoth": { TU_NGA: 5.4, YEU_BI: 2.6, YEU_COT: 1.7 },
    "mandalorian": { GIAP_XAC: 5.0, LINH_VU: 1.6, YEU_HUYET: 1.0 },
    "phoenix": { LINH_VU: 5.9, YEU_DAN: 1.9, THIEN_LINH_QUA: 0.55 },
    "raven": { LINH_VU: 4.8, LINH_TY: 1.7, YEU_HUYET: 1.1 },
    "ryu": { LONG_LAN: 5.6, YEU_DAN: 2.1, YEU_HUYET: 1.5 },
    "set-troll": { YEU_BI: 5.0, YEU_COT: 2.2, TINH_THIT: 1.8 },
    ...
    "abstract-005": { GIAP_XAC: 4.6, LINH_LAN: 2.1, HUYEN_HOA_LIEN: 0.22 },
    "afk-arena": { GIAP_XAC: 4.5, YEU_COT: 1.8, THIEN_LINH_QUA: 0.18 },
    "axolotl": { LINH_LAN: 5.1, YEU_HUYET: 1.9, TUYET_NGOC_THAO: 0.42 },
    "boar": { YEU_NANH: 5.2, YEU_BI: 2.1, TINH_THIT: 1.8 },
    "bulb": { LINH_TY: 4.3, NGAN_NAM_HOANG_TINH: 0.92, THIEN_LINH_QUA: 0.24 },
    "capybara": { YEU_BI: 4.4, LINH_MAO: 2.1, TINH_THIT: 1.6 },
    "caterpillar": { LINH_TY: 5.0, PHONG_CHAM: 2.0, DOC_NANG: 1.1 },
    "cracked-alien-skull": { YEU_COT: 5.3, DOC_NANG: 2.0, HUYEN_HOA_LIEN: 0.34 },
    "cyber-eye": { YEU_DAN: 4.6, GIAP_XAC: 2.2, THIEN_LINH_QUA: 0.28 },
    "deer2": { YEU_GIAC: 5.0, LINH_MAO: 1.9, NGAN_NAM_HOANG_TINH: 0.76 },
    "deku-tree": { LINH_TY: 4.7, NGAN_NAM_HOANG_TINH: 0.98, HUYEN_HOA_LIEN: 0.26 },
    "delighted": { LINH_MAO: 4.0, YEU_HUYET: 1.7, THIEN_LINH_QUA: 0.16 },
    "evil-tree": { DOC_NANG: 4.8, LINH_TY: 2.2, HUYEN_HOA_LIEN: 0.31 },
    "foam": { LINH_LAN: 4.6, XUC_TU: 2.0, TUYET_NGOC_THAO: 0.35 },
    "jellyfish": { XUC_TU: 4.9, DOC_NANG: 2.6, YEU_HUYET: 1.3 },
    "maggot-mini": { TINH_THIT: 4.2, DOC_NANG: 1.6, YEU_HUYET: 1.2 },
    "masked-spider": { LINH_TY: 5.1, PHONG_CHAM: 2.5, DOC_NANG: 1.7 },
    "medusa-head": { DOC_NANG: 5.2, LINH_TY: 2.1, HUYEN_HOA_LIEN: 0.44 },
    "megabot": { GIAP_XAC: 5.4, YEU_COT: 2.1, YEU_DAN: 1.0 },
    "mermaid": { LINH_LAN: 4.8, LINH_VU: 1.8, THIEN_LINH_QUA: 0.33 },
    "metroid": { DOC_NANG: 4.9, YEU_DAN: 1.9, HUYEN_HOA_LIEN: 0.29 },
    "nautilus-shell": { GIAP_XAC: 5.1, LINH_LAN: 2.3, TUYET_NGOC_THAO: 0.38 },
    "phalcon": { LINH_VU: 5.0, YEU_NANH: 1.8, THIEN_LINH_QUA: 0.27 },
    "piranha": { YEU_NANH: 5.0, LINH_LAN: 2.4, TINH_THIT: 1.5 },
    "porcupinefish": { PHONG_CHAM: 5.1, DOC_NANG: 2.2, LINH_LAN: 1.5 },
    "robot-golem": { GIAP_XAC: 5.5, YEU_COT: 2.3, YEU_DAN: 0.9 },
    "rock-golem": { GIAP_XAC: 5.6, YEU_COT: 2.4, HUYEN_HOA_LIEN: 0.21 },
    "saber-toothed-cat-head": { YEU_NANH: 5.8, LINH_MAO: 2.0, YEU_HUYET: 1.5 },
    "salmon": { LINH_LAN: 5.0, TINH_THIT: 2.3, YEU_HUYET: 1.1 },
    "sand-snake": { DOC_NANG: 5.0, YEU_NANH: 1.9, LINH_TY: 1.4 },
    "space-suit": { GIAP_XAC: 4.8, YEU_DAN: 2.0, TUYET_NGOC_THAO: 0.24 },
    "spark-spirit": { LINH_VU: 4.4, YEU_DAN: 2.1, THIEN_LINH_QUA: 0.32 },
    "spectre": { YEU_HUYET: 4.7, YEU_DAN: 2.0, HUYEN_HOA_LIEN: 0.41 },
    "tadpole": { LINH_LAN: 4.4, TINH_THIT: 1.9, TUYET_NGOC_THAO: 0.29 },
    "wasp-sting": { PHONG_CHAM: 5.3, DOC_NANG: 2.5, LINH_VU: 1.2 },
});
...
const CONFIG = {
    ...
    INPUT: {
        JOYSTICK_CURSOR_SPEED: 0.1000, // Giảm tốc phản hồi con trỏ khi kéo joystick trên mobile để dễ điều khiển hơn
    ...
    ENEMY: {
        ...
        MATERIAL_DROPS: ENEMY_MATERIAL_DROPS,
        ANIMALS: Object.keys(ENEMY_MATERIAL_DROPS).map(animalKey => imagePath(`animals/${animalKey}.svg`)),
    },
    ITEMS: {
    ...
    SPIRIT_STONE: {
        ...
        STARTING_COUNTS: {
            LOW: 0,     // Số lượng hạ phẩm linh thạch ban đầu để dev test nhanh
